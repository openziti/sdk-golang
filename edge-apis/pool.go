...
// IterateRandomTransport returns a channel that yields all transports in random order.
...
// selectAndRemoveRandom randomly selects an element from the slice and returns both
// the selected element and a new slice with that element removed.
