...
require (
	...
	github.com/openziti/channel/v2 v2.0.71 // indirect
	github.com/openziti/edge-api v0.25.21 // indirect
	github.com/openziti/identity v1.0.51 // indirect
	github.com/openziti/metrics v1.2.23 // indirect
	github.com/openziti/secretstream v0.1.7 // indirect
	github.com/openziti/transport/v2 v2.0.82 // indirect
