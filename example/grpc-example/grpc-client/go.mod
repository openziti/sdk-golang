module github.com/openziti/sdk-golang/example/grpc-example/grpc-client
...
require (
	...
	github.com/openziti/channel v0.18.46 // indirect
	github.com/openziti/foundation v0.17.31 // indirect
	github.com/openziti/transport/v2 v2.0.10 // indirect
