...
// If the version can't be fetched or parsed, the cache is left unpopulated so the next
// capability check retries, rather than pinning capabilities based on a transient failure.
